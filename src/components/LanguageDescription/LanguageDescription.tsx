...
interface LanguageDescriptionProps{
    handleChange: (e:string, level: string, index: string) => void;
...
export function LanguageDescription({handleChange,index,handleRemove,languageSelect,levelSelect}: LanguageDescriptionProps) {
